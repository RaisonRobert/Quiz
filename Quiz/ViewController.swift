...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 0...4 {
            let perg = listaPerguntas[cont].listaResposta[i].0
            textresposta[i].setTitle(perg, for: .normal)
        }
    }
    
    @IBAction func resposta01(_ sender: Any) {
        if(listaPerguntas[cont].listaResposta[0].1){
            result += 1
        }
        if (cont < 9){
        cont+=1
    ...
    @IBAction func resposta02(_ sender: Any) {
        if(listaPerguntas[cont].listaResposta[1].1){
            result += 1
        }
        if (cont < 9){
        cont+=1
...
//            print(result)
    ...
    @IBAction func resposta03(_ sender: Any) {
        if(listaPerguntas[cont].listaResposta[2].1){
            result += 1
        }
        if (cont < 9){
        cont+=1
...
//            print(result)
    ...
    @IBAction func resposta04(_ sender: Any) {
        if(listaPerguntas[cont].listaResposta[3].1){
            result += 1
        }
        if (cont < 9){
        cont+=1
...
//            print(result)
    ...
    @IBAction func resposta05(_ sender: Any) {
        if(listaPerguntas[cont].listaResposta[4].1){
            result += 1
        }
        if (cont < 9){
        cont+=1
...
//            print(result)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "homeToFinal" {
            if let next = segue.destination as? FinalViewController {
                next.final = result
            }
        }
    }
